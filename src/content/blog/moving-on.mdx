...
Okay, so what I am looking for is an animation that builds up the *keffiyeh* while a user scrolls. Right now, I am using a GSAP Timeline and Scrolltrigger. I am thinking that a sort of nitting pattern could be cool, so that is where I am starting.
