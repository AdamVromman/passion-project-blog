...
Okay, so I can see that more than a thousand cubes becomes really hard for the browser to handle. We will have to check how it goes with some other tests and then, after that, with the other framesworks.
